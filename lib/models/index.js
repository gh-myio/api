...
const Models = {
  ...
  Favorites: require('./favorites')(sequelize),
  NodeRedPersist: require('./nodered_persist')(sequelize),
  Environment: require('./environment')(sequelize)
}
