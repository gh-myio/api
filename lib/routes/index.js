...
const isUserAdminMiddleware = ({ headers: { 'x-access-token': token } }, res, next) => utils.isUserAdmin(token) ? next() : res.status(403).send()
...
module.exports = (express) => {
  ...
  express.get('/environment', isUserAdminMiddleware, environment.find)
  express.get('/environment/:key', isUserAdminMiddleware, environment.find)
  express.put('/environment/:key', isUserAdminMiddleware, environment.put)
  express.delete('/environment/:key', isUserAdminMiddleware, environment.destroy)
  ...
  express.post('/ambients/batch', ambients.patchMany)
  ...
  express.post('/slaves/:slaveId/temperature/:temperature', slaves.setTemperature)
  ...
  express.get('/scenes/:id/activate', scenes.activate)
  express.put('/scenes/:id/activate', scenes.activate)
  express.post('/scenes/:id/activate', scenes.activate)
